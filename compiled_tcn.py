...
def compiled_tcn(num_feat,  # type: int
    ...
    input_layer = Input(shape=(1, num_feat))
    ...
    # def get_opt():
    #     if opt == 'adam':
    #         return tf.optimizers.Adam(learning_rate=learning_rate, clipnorm=1.)
    #     elif opt == 'rmsprop':
    #         return tf.optimizers.RMSprop(learning_rate=learning_rate, clipnorm=1.)
    #     else:
